    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('levels', models.ManyToManyField(to='api.level')),
                ('line_spacing', models.ManyToManyField(to='api.linespacing')),
                ('service_type', models.ManyToManyField(to='api.servicetype')),
                ('skills', models.ManyToManyField(to='api.skill')),
                ('style', models.ManyToManyField(to='api.style')),
                ('subjects', models.ManyToManyField(to='api.subject')),
                ('files', models.ManyToManyField(blank=True, related_name='jobs_files', to='api.uploadfile')),
